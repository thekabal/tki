...
else
{
    ...
    while ($i < $num_traderoutes)
    {
        ...
        if ($traderoutes[$i]['move_type'] == 'R')
        {
            ...
            $dist = Bad\Traderoute::traderouteDistance($pdo_db, $db, $langvars, $traderoutes[$i]['source_type'], $traderoutes[$i]['dest_type'], $src, $dst, $traderoutes[$i]['circuit'], $playerinfo, $tkireg);
