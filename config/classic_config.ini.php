...
release_version            = '0.8';                            // Please do not change this. Doing so will cause problems for the server lists, and setupinfo, and more.
...
link_forums                = 'http://kabal.tk/forums/';        // Address for the forum link
