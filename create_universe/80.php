...
$resxx = $stmt->execute();
$variables['update_turns_results']['result'] = Tki\Db::logDbErrors($pdo_db, $pdo_db, $resxx, __LINE__, __FILE__);
...
$variables['update_xenobe_results']['result'] = Tki\Db::logDbErrors($pdo_db, $pdo_db, $db, $resxx, __LINE__, __FILE__);
...
$stmt->bindParam(':last_run', $now);
$resxx = $stmt->execute();
$variables['update_ibank_results']['result'] = Tki\Db::logDbErrors($pdo_db, $pdo_db, $resxx, __LINE__, __FILE__);
...
$stmt->bindParam(':last_run', $now);
$resxx = $stmt->execute();
$variables['update_news_results']['result'] = Tki\Db::logDbErrors($pdo_db, $pdo_db, $resxx, __LINE__, __FILE__);
...
$stmt->bindParam(':last_run', $now);
$resxx = $stmt->execute();
$variables['update_planets_results']['result'] = Tki\Db::logDbErrors($pdo_db, $pdo_db, $resxx, __LINE__, __FILE__);
...
$stmt->bindParam(':last_run', $now);
$resxx = $stmt->execute();
$variables['update_ports_results']['result'] = Tki\Db::logDbErrors($pdo_db, $pdo_db, $resxx, __LINE__, __FILE__);
...
$stmt->bindParam(':last_run', $now);
$resxx = $stmt->execute();
$variables['update_tow_results']['result'] = Tki\Db::logDbErrors($pdo_db, $pdo_db, $resxx, __LINE__, __FILE__);
...
$stmt->bindParam(':last_run', $now);
$resxx = $stmt->execute();
$variables['update_ranking_results']['result'] = Tki\Db::logDbErrors($pdo_db, $pdo_db, $resxx, __LINE__, __FILE__);
...
$stmt->bindParam(':last_run', $now);
$resxx = $stmt->execute();
$variables['update_degrade_results']['result'] = Tki\Db::logDbErrors($pdo_db, $pdo_db, $resxx, __LINE__, __FILE__);
...
$stmt->bindParam(':last_run', $now);
$resxx = $stmt->execute();
$variables['update_apoc_results']['result'] = Tki\Db::logDbErrors($pdo_db, $pdo_db, $resxx, __LINE__, __FILE__);
...
$stmt->bindParam(':last_run', $now);
$resxx = $stmt->execute();
$variables['update_gov_results']['result'] = Tki\Db::logDbErrors($pdo_db, $pdo_db, $resxx, __LINE__, __FILE__);
...
$resxx = $stmt->execute();
$variables['first_news_results']['result'] = Tki\Db::logDbErrors($pdo_db, $pdo_db, $resxx, __LINE__, __FILE__);
$local_table_timer->stop();
...
$variables['ibank_results']['result'] = Tki\Db::logDbErrors($pdo_db, $pdo_db, $update, __LINE__, __FILE__);
$local_table_timer->stop();
...
for ($zz=0; $zz<$tkireg->max_presets; $zz++)
{
    ...
    $resxx = $stmt->execute();
    $variables['admin_preset_results'][$zz]['result'] = Tki\Db::logDbErrors($pdo_db, $pdo_db, $resxx, __LINE__, __FILE__);
...
$resxx = $stmt->execute();
$variables['admin_zone_results']['result'] = Tki\Db::logDbErrors($pdo_db, $pdo_db, $resxx, __LINE__, __FILE__);
$local_table_timer->stop();
