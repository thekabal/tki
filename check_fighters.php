...
/**
 * check_fighters.php from The Kabal Invasion.
...
$num_defenses = $i;
if ($num_defenses > 0 && $total_sector_fighters > 0 && !$owner)
{
        ...
        switch ($response)
        {
            ...
            case "pay":
                ...
                else
                {
                    ...
                    Tki\Db::logDbErrors($pdo_db, $resx, __LINE__, __FILE__);
                    Tki\Toll::distribute($pdo_db, $sector, $fighterstoll, (int) $total_sector_fighters);
