...
class IbankTransferFinal
{
    public static function final(\PDO $pdo_db, string $lang, array $playerinfo, $ship_id, int $splanet_id, int $dplanet_id, int $amount, Reg $tkireg, Timer $tkitimer, Smarty $template): void
    {
        ...
        if ($ship_id !== null) // Ship transfer
        {
            ...
            {
                \Tki\Ibank::ibankError($pdo_db, $langvars['l_ibank_errsendyourself'], "ibank.php?command=transfer", $lang, $tkireg, $tkitimer, $template);
            }
            ...
            if ($target['turns_used'] < $tkireg->ibank_min_turns)
            {
                ...
                \Tki\Ibank::ibankError($pdo_db, $langvars['l_ibank_min_turns3'], "ibank.php?command=transfer", $lang, $tkireg, $tkitimer, $template);
            }
            ...
            if ($playerinfo['turns_used'] < $tkireg->ibank_min_turns)
            {
                ...
                \Tki\Ibank::ibankError($pdo_db, $langvars['l_ibank_min_turns4'], "ibank.php?command=transfer", $lang, $tkireg, $tkitimer, $template);
            }
            ...
            if ($tkireg->ibank_trate > 0)
            {
                ...
                if ($time !== null)
                {
                    ...
                    \Tki\Ibank::ibankError($pdo_db, $langvars['l_ibank_mustwait2'], "ibank.php?command=transfer", $lang, $tkireg, $tkitimer, $template);
                }
            }

            if (($amount * 1) != $amount)
            {
                \Tki\Ibank::ibankError($pdo_db, $langvars['l_ibank_invalidtransferinput'], "ibank.php?command=transfer", $lang, $tkireg, $tkitimer, $template);
            }

            if ($amount == 0)
            {
                \Tki\Ibank::ibankError($pdo_db, $langvars['l_ibank_nozeroamount'], "ibank.php?command=transfer", $lang, $tkireg, $tkitimer, $template);
            }

            if ($amount > $bank_account['balance'])
            {
                \Tki\Ibank::ibankError($pdo_db, $langvars['l_ibank_notenoughcredits'], "ibank.php?command=transfer", $lang, $tkireg, $tkitimer, $template);
            }
            ...
            if ($tkireg->ibank_svalue != 0)
            {
                ...
                if ($amount > $maxtrans)
                {
                    \Tki\Ibank::ibankError($pdo_db, $langvars['l_ibank_amounttoogreat'], "ibank.php?command=transfer", $lang, $tkireg, $tkitimer, $template);
                }
            }
        ...
        else
        {
            ...
            {
                \Tki\Ibank::ibankError($pdo_db, $langvars['l_ibank_notenoughcredits2'], "ibank.php?command=transfer", $lang, $tkireg, $tkitimer, $template);
            }
