...
class Traderoute
{
    public static function engage(\PDO $pdo_db, $old_db, string $lang, int $tr_repeat, array $langvars, Reg $tkireg, array $playerinfo, int $engage, array $traderoutes, ?int $portfull, Smarty $template): void
    {
        $traderoute = array();
        $source = array();
        $dest = array();
