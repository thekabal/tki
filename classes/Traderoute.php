...
class Traderoute
{
    public static function traderouteEngage($db, \PDO $pdo_db, string $lang, int $j, array $langvars, Reg $tkireg, array $playerinfo, int $engage, array $dist, array $traderoutes, int $portfull, Smarty $template)
    {
        $traderoute = array();
        $source = array();
        $dest = array();
