...
class Traderoute
{
    ...
    public static function traderouteDistance($pdo_db, $db, $langvars, string $type1, string $type2, $start, $dest, $circuit, $playerinfo, \Tki\Reg $tkireg, $sells = 'N')
    {
        $retvalue = array();
        $retvalue['triptime'] = 0;
        $retvalue['scooped1'] = 0;
    ...
    public static function traderouteDelete($pdo_db, $db, $lang, $langvars, \Tki\Reg $tkireg, $template, $playerinfo, $confirm, $traderoute_id, $traderoutes)
    {
    ...
    public static function traderouteSettings($pdo_db, $lang, \Tki\Reg $tkireg, $template, $playerinfo)
    {
        $langvars = \Tki\Translate::load($pdo_db, $lang, array('traderoutes', 'common', 'global_includes', 'global_funcs', 'footer', 'regional'));
