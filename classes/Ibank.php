...
class Ibank
{
    ...
    public static function ibankConsolidate3($db, \PDO $pdo_db, $langvars, $playerinfo, \Tki\Reg $tkireg, $dplanet_id, $minimum, $maximum)
    {
        ...
        if (!$res || $res->EOF)
        {
            self::ibankError($pdo_db, $active_template, $langvars, $langvars['l_ibank_errunknownplanet'], "ibank.php?command=transfer", $tkireg, "Error", $template);
        }
        ...
        if ($dest['owner'] != $playerinfo['ship_id'])
        {
            self::ibankError($pdo_db, $active_template, $langvars, $langvars['l_ibank_errnotyourplanet'], "ibank.php?command=transfer", $tkireg, "Error", $template);
        }
        ...
        {
            self::ibankError($pdo_db, $active_template, $langvars, $langvars['l_ibank_notenturns'], "ibank.php?command=transfer", $tkireg, "Error", $template);
        }
