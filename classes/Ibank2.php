...
class Ibank2
{
    public static function ibankWithdraw2(\PDO $pdo_db, string $lang, array $langvars, array $playerinfo, $amount, string $account, Reg $tkireg, Smarty $template)
    {
    ...
    public static function ibankTransfer2(\PDO $pdo_db, string $lang, array $langvars, Reg $tkireg, array $playerinfo, string $account, int $ship_id, int $splanet_id, int $dplanet_id, Smarty $template)
    {
    ...
    public static function ibankDeposit2(\PDO $pdo_db, string $lang, array $langvars, array $playerinfo, $amount, string $account, Reg $tkireg, Smarty $template)
    {
    ...
    public static function ibankConsolidate2(\PDO $pdo_db, string $lang, array $langvars, array $playerinfo, Reg $tkireg, int $dplanet_id, int $minimum, int $maximum, Smarty $template)
    {
        $sql = "SELECT name, credits, owner, sector_id FROM ::prefix::planets WHERE planet_id=:planet_id";
        $stmt = $pdo_db->prepare($sql);
        $stmt->bindParam(':planet_id', $dplanet_id);
