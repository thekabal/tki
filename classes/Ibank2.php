...
class Ibank2
{
    public static function ibankWithdraw2(\PDO $pdo_db, string $lang, array $langvars, array $playerinfo, $amount, string $account, Reg $tkireg, string $template)
    {
        $amount = preg_replace("/[^0-9]/", '', $amount);
        if (($amount * 1) != $amount)
        {
            \TkiIbank::ibankError($pdo_db, $langvars, $langvars['l_ibank_invalidwithdrawinput'], "ibank.php?command=withdraw", $lang, $tkireg, $template);
        }

        if ($amount == 0)
        {
            \TkiIbank::ibankError($pdo_db, $langvars, $langvars['l_ibank_nozeroamount3'], "ibank.php?command=withdraw", $lang, $tkireg, $template);
        }

        if ($amount > $account['balance'])
        {
            \TkiIbank::ibankError($pdo_db, $langvars, $langvars['l_ibank_notenoughcredits'], "ibank.php?command=withdraw", $lang, $tkireg, $template);
        }
    ...
    public static function ibankTransfer2(\PDO $pdo_db, string $lang, array $langvars, Reg $tkireg, array $playerinfo, string $account, int $ship_id, int $splanet_id, int $dplanet_id, string $template)
    {
        if ($ship_id !== null) // Ship transfer
        {
            if ($playerinfo['ship_id'] == $ship_id)
            {
                \TkiIbank::ibankError($pdo_db, $langvars, $langvars['l_ibank_sendyourself'], "ibank.php?command=transfer", $lang, $tkireg, $template);
            }
            ...
            if ($target['turns_used'] < $tkireg->ibank_min_turns)
            {
                ...
                \TkiIbank::ibankError($pdo_db, $langvars, $langvars['l_ibank_min_turns'], "ibank.php?command=transfer", $lang, $tkireg, $template);
            }
            ...
            if ($playerinfo['turns_used'] < $tkireg->ibank_min_turns)
            {
                ...
                \TkiIbank::ibankError($pdo_db, $langvars, $langvars['l_ibank_min_turns2'], "ibank.php?command=transfer", $lang, $tkireg, $template);
            }
            ...
            if ($tkireg->ibank_trate > 0)
            {
                ...
                if ($time !== null)
                {
                    ...
                    \TkiIbank::ibankError($pdo_db, $langvars, $langvars['l_ibank_mustwait'], "ibank.php?command=transfer", $lang, $tkireg, $template);
                }
            }
        ...
        else
        {
            ...
            if ($dest['base'] == 'N')
            {
                \TkiIbank::ibankError($pdo_db, $langvars, $langvars['l_ibank_errnobase'], "ibank.php?command=transfer", $lang, $tkireg, $template);
            }
    ...
    public static function ibankTransfer3(\ADODB_mysqli $db, \PDO $pdo_db, string $lang, array $langvars, array $playerinfo, string $account, int $ship_id, int $splanet_id, int $dplanet_id, $amount, Reg $tkireg, string $template)
    {
        $amount = preg_replace("/[^0-9]/", '', $amount);
        ...
        if ($ship_id !== null) // Ship transfer
        {
            ...
            if ($target['turns_used'] < $tkireg->ibank_min_turns)
            {
                ...
                \TkiIbank::ibankError($pdo_db, $langvars, $langvars['l_ibank_min_turns3'], "ibank.php?command=transfer", $lang, $tkireg, $template);
            }

            if ($playerinfo['turns_used'] < $tkireg->ibank_min_turns)
            {
                $langvars['l_ibank_min_turns4'] = str_replace("[ibank_min_turns]", $tkireg->ibank_min_turns, $langvars['l_ibank_min_turns4']);
                \TkiIbank::ibankError($pdo_db, $langvars, $langvars['l_ibank_min_turns4'], "ibank.php?command=transfer", $lang, $tkireg, $template);
            }
            ...
            if ($tkireg->ibank_trate > 0)
            {
                ...
                if ($time !== null)
                {
                    ...
                    \TkiIbank::ibankError($pdo_db, $langvars, $langvars['l_ibank_mustwait2'], "ibank.php?command=transfer", $lang, $tkireg, $template);
                }
            }

            if (($amount * 1) != $amount)
            {
                \TkiIbank::ibankError($pdo_db, $langvars, $langvars['l_ibank_invalidtransferinput'], "ibank.php?command=transfer", $lang, $tkireg, $template);
            }

            if ($amount == 0)
            {
                \TkiIbank::ibankError($pdo_db, $langvars, $langvars['l_ibank_nozeroamount'], "ibank.php?command=transfer", $lang, $tkireg, $template);
            }

            if ($amount > $account['balance'])
            {
                \TkiIbank::ibankError($pdo_db, $langvars, $langvars['l_ibank_notenoughcredits'], "ibank.php?command=transfer", $lang, $tkireg, $template);
            }
            ...
            if ($tkireg->ibank_svalue != 0)
            {
                ...
                if ($amount > $maxtrans)
                {
                    \TkiIbank::ibankError($pdo_db, $langvars, $langvars['l_ibank_amounttoogreat'], "ibank.php?command=transfer", $lang, $tkireg, $template);
                }
            }
        ...
        else
        {
            ...
            {
                \TkiIbank::ibankError($pdo_db, $langvars, $langvars['l_ibank_notenoughcredits2'], "ibank.php?command=transfer", $lang, $tkireg, $template);
            }
    ...
    public static function ibankDeposit2(\PDO $pdo_db, string $lang, array $langvars, array $playerinfo, $amount, string $account, Reg $tkireg, string $template)
    {
        ...
        if (($amount * 1) != $amount)
        {
            \TkiIbank::ibankError($pdo_db, $langvars, $langvars['l_ibank_invaliddepositinput'], "ibank.php?command=deposit", $lang, $tkireg, $template);
        }

        if ($amount == 0)
        {
            \TkiIbank::ibankError($pdo_db, $langvars, $langvars['l_ibank_nozeroamount2'], "ibank.php?command=deposit", $lang, $tkireg, $template);
        }

        if ($amount > $playerinfo['credits'])
        {
            \TkiIbank::ibankError($pdo_db, $langvars, $langvars['l_ibank_notenoughcredits'], "ibank.php?command=deposit", $lang, $tkireg, $template);
        }
        ...
        {
            \TkiIbank::ibankError($pdo_db, $langvars, "<center>Error You cannot deposit that much into your bank,<br> (Max Credits Reached)</center>", "ibank.php?command=deposit", $lang, $tkireg, $template);
        }
    ...
    public static function ibankConsolidate2(\PDO $pdo_db, string $lang, array $langvars, array $playerinfo, Reg $tkireg, int $dplanet_id, int $minimum, int $maximum, string $template)
    {
        $sql = "SELECT name, credits, owner, sector_id FROM ::prefix::planets WHERE planet_id=:planet_id";
        $stmt = $pdo_db->prepare($sql);
        $stmt->bindParam(':planet_id', $dplanet_id);
    ...
    public static function ibankConsolidate3(\PDO $pdo_db, array $langvars, array $playerinfo, Reg $tkireg, int $dplanet_id, int $minimum, int $maximum, string $lang, string $template)
    {
        $sql = "SELECT name, credits, owner, sector_id FROM ::prefix::planets WHERE planet_id=:planet_id";
        $stmt = $pdo_db->prepare($sql);
        $stmt->bindParam(':planet_id', $dplanet_id);
