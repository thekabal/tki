    ...
    public static function planetCombat(\PDO $pdo_db, \ADODB_mysqli $db, $lang, Array $langvars, Reg $tkireg, $template, Array $playerinfo, $ownerinfo, $planetinfo)
    {
        ...
        if ($shipsonplanet > 0)
        {
            ...
            while (!$result4->EOF)
            {
                ...
                \Tki\Combat::shipToShip($db, $onplanet['ship_id'], $tkireg, $playerinfo, $attackerbeams, $attackerfighters, $attackershields, $attackertorps, $attackerarmor, $attackertorpdamage);
                $result4->MoveNext();
            }
        }
        else
