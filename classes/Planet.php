    ...
    public static function planetCombat(\PDO $pdo_db, \ADODB_mysqli $db, string $lang, array $langvars, Reg $tkireg, Smarty $template, array $playerinfo, $ownerinfo, $planetinfo)
    {
        ...
        if ($shipsonplanet > 0)
        {
            ...
            while (!$result4->EOF)
            {
                ...
                \Tki\Combat::shipToShip($pdo_db, $onplanet['ship_id'], $tkireg, $playerinfo, $attackerbeams, $attackerfighters, $attackershields, $attackertorps, $attackerarmor, $attackertorpdamage);
                $result4->MoveNext();
            }
        }
        else
