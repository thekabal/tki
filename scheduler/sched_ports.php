...
$debug = Tki\Db::logDbErrors($pdo_db, $db, $resa, __LINE__, __FILE__);
is_query_ok($pdo_db, $db, $debug);
...
$debug = Tki\Db::logDbErrors($pdo_db, $db, $resb, __LINE__, __FILE__);
is_query_ok($pdo_db, $db, $debug);

echo "Ensuring minimum ore levels are 0...";
$resc = $db->Execute("UPDATE {$db->prefix}universe SET port_ore = 0 WHERE port_ore < 0");
$debug = Tki\Db::logDbErrors($pdo_db, $db, $resc, __LINE__, __FILE__);
is_query_ok($pdo_db, $db, $debug);
echo "<br>";
...
$debug = Tki\Db::logDbErrors($pdo_db, $db, $resd, __LINE__, __FILE__);
is_query_ok($pdo_db, $db, $debug);
...
$debug = Tki\Db::logDbErrors($pdo_db, $db, $rese, __LINE__, __FILE__);
is_query_ok($pdo_db, $db, $debug);
...
$debug = Tki\Db::logDbErrors($pdo_db, $db, $resf, __LINE__, __FILE__);
is_query_ok($pdo_db, $db, $debug);
echo "<br>";
...
$debug = Tki\Db::logDbErrors($pdo_db, $db, $resg, __LINE__, __FILE__);
is_query_ok($pdo_db, $db, $debug);
...
$debug = Tki\Db::logDbErrors($pdo_db, $db, $resj, __LINE__, __FILE__);
is_query_ok($pdo_db, $db, $debug);
...
$debug = Tki\Db::logDbErrors($pdo_db, $db, $resm, __LINE__, __FILE__);
is_query_ok($pdo_db, $db, $debug);
...
$debug = Tki\Db::logDbErrors($pdo_db, $db, $resn, __LINE__, __FILE__);
is_query_ok($pdo_db, $db, $debug);
...
$debug = Tki\Db::logDbErrors($pdo_db, $db, $reso, __LINE__, __FILE__);
is_query_ok($pdo_db, $db, $debug);
...
$debug = Tki\Db::logDbErrors($pdo_db, $db, $resp, __LINE__, __FILE__);
is_query_ok($pdo_db, $db, $debug);
$multiplier = 0;
