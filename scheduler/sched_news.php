...
Tki\Db::logDbErrors($pdo_db, $db, $sql, __LINE__, __FILE__);
...
while (!$sql->EOF)
{
    ...
    if ($row['total_planets'] >= 1000)
    {
        ...
        Tki\Db::logDbErrors($pdo_db, $db, $sql2, __LINE__, __FILE__);
        ...
        if ($sql2->EOF)
        {
            ...
            Tki\Db::logDbErrors($pdo_db, $db, $news, __LINE__, __FILE__);
        }
    }
