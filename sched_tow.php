...
do
{
    ...
    if ($res)
    {
        ...
        while (!$res->EOF)
        {
            ...
            $newsector = Tki\Rand::betterRand(0, $sector_max - 1);
            ...
            Tki\PlayerLog::writeLog($db, $row['ship_id'], LOG_TOW, "$row[sector]|$newsector|$row[max_hull]");
            Tki\LogMove::writeLog($db, $row['ship_id'], $newsector);
            $res->MoveNext();
        }
    }
    else
