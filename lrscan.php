...
if ($sector == "*")
{
    ...
    while (!$result->EOF)
    {
        ...
        Tki\Db::logDbErrors($pdo_db, $db, $resultSDa, __LINE__, __FILE__);
        ...
        Tki\Db::logDbErrors($pdo_db, $db, $resultSDb, __LINE__, __FILE__);
...
else
{
    ...
    Tki\Db::logDbErrors($pdo_db, $db, $result3a, __LINE__, __FILE__);
    $i = 0;
    $flag = 0;
